...
app.p10.bind_touch_event = function(){
     $(".e-10-2").on("touchend", function(){
          $(".e-10-2").hide();
          $(".e-10-3").hide();          
          $(".logo").hide();       
          app.show_e2_overlay8();
      }); 
};
app.show_e2_overlay8 = function(){
    window.overlay8= new mo.Overlay({
        content: '<img class="e10-8" src="img/p10/e-7.png"><img class="e-12-8" src="img/e-12.png" alt="" />',
        width:640,
        height:1031
    });
    overlay8.on('open', function(){
        $(".e-12-8").css({"top": "45px","left": "50px","position":"absolute"});
        $(".e-12-8").on('touchend', function(){
            window.overlay8.close();
            $(".e-10-2").show();
            $(".e-10-3").show(); 
        });
    });
};
app.p10.setuser=function(){
...
app.shareoverload.show_e2_overlay = function(){
    ...
    window.overlay= new mo.Overlay({
        content: '<img class="e-10-1" src="img/p10/e-'+page+'.png" ><img class="e-12-1" src="img/e-12.png" alt="" />',
        width:640,
        height:1031
    });
